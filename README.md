...
**Goal**
- Analysis of payments by gender to generate insights for understanding payment disparities and underlying skill gaps.

**Data source**
- The analysis has been done on dataset published by OpenPaymentsData.CMS.gov. The data is published with the aim to provide financial transparecncy within centers of medicare and medicaid services in United states. It comproses of payments made by healthcare companies to various stake holders like research organizations involved in drug discovery, teaching hospitals, physicians and non-physicians involved in clinical trials. The payments are made by pharmaceuticals, medical device manufacturers, GPO group purchase organizations, the distributors of drugs, medical and biological supplies. The data is published evey year. This analysis is for year 2023. The general and research payment datasets were analyzed. https://openpaymentsdata.cms.gov/datasets
...
General payments and research payments were analyzed. 
...
**Outcomes**
- Healthcare is a biggest employer in United states. Overall the gender ratio was balanced. However the data insights revealed that there were more female employees in non-physian roles 70-75% and at physician and research roles on average females represented 30% workforce.
